...
function Library:Toggle(value)
    local gui = game:GetService("CoreGui"):FindFirstChild("Neverlose")
...
function Library:Window(options)
    ...
    local function ToggleWindow()
        SetWindowVisible(not SG.Enabled)
    end
    ...
    CloseButton.BackgroundColor3 = Color3.fromRGB(13, 28, 44)
    ...
    CloseButton.Text = "X"
    CloseButton.TextColor3 = Color3.fromRGB(157, 171, 182)
    ...
    CloseButtonStroke.Color = Color3.fromRGB(2, 162, 243)
    CloseButtonStroke.Transparency = 0.55
    CloseButtonStroke.Thickness = 1

    CloseButton.MouseEnter:Connect(function()
        TweenService:Create(CloseButton, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
            BackgroundColor3 = Color3.fromRGB(70, 20, 32),
            TextColor3 = Color3.fromRGB(234, 239, 246)
        }):Play()
        TweenService:Create(CloseButtonStroke, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
    ...
    CloseButton.MouseLeave:Connect(function()
        ...
        TweenService:Create(CloseButtonStroke, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
            Color = Color3.fromRGB(2, 162, 243),
            Transparency = 0.55
        }):Play()
    end)
